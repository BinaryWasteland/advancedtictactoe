...
namespace TicTacToeClient
{
    public class TicTacToeState
    {
        ...
        public enum Symbol { USER = 'X', PROG = 'O' }; // ASCII value of character used by each player
        public enum Who { USER = 0, PROG, NOBODY }; // Programmatic identifier used for each player
        public Who Winner = Who.PROG;
